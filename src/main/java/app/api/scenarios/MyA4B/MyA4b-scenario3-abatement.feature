...
Feature: Setup user to employer
    ...
    Scenario:      
		...
		* def paearningsRsp = call read('classpath:app/api/reload/services-css/posts/CreateAbatementEarnings.feature') { benefitCaseNo: '#(wceCaseNo)',occupationIValue: '#(occIvalue)',gcUserId: '#(eosGCUserId)'} 		
