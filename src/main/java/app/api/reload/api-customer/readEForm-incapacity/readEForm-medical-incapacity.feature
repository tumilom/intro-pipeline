@customer_readEForm-medical-incapacity
Feature: customer_readEForm
    Background: 
		...
		* def str_eFormType = 'Medical Incapacity'
    ...
    Scenario:  customer api readEForm
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/api-customer/readEForm-medical-incapacity/readEForm-medical-incapacity-basic-flow-response 24.5.txt')
		* print response			
		Then status 200
