@ignore
@capi_approvalOrders-invalid-format
Feature: capi approval-orders
    ...
    Scenario: <claimNumber> approval-orders
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/api-customer/approvalOrder/approvalOrders-invalid-format 24.2.txt')
		* print response
		Then status 200
