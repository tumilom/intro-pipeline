@ignore
@customer_actual-earnings-basic-flow
Feature: customer actual-earnings
    Background: 
		...
		* def occupationId = '11614-78547671'
    ...
    Scenario:  customer api actual-earnings
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/api-customer/actual-earnings/actual-earnings-basic-flow-response 24.5.txt')
		* print response			
		Then status 200		