@ignore
@customer_claims-basic-flow-multiple
Feature: customer claims
    ...
    Scenario:  customer api payment-preferences
	   ...
	   * configure headers = GET_HTTP_HEADER
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/api-customer/claims/claims-basic-flow-multiple reponse 24.2.txt')
			* print response			
		Then status 200
