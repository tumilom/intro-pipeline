@ignore
@customer_removeTaxCodeRecord-invalid-taxcodeId
Feature: customer remove Tax Code Record
    ...
    Scenario:  
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/api-customer/posts/removeTaxCodeRecord/removeTaxCodeRecord-invalid-taxcodeId reponse 24.2.txt')
		* print response
        Then status 200