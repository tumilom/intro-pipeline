@ignore
@customer_occupations-basic-flow1036Retest
Feature: customer occupations
    ...
    Scenario:  customer api payment-preferences
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/api-customer/A/occupations-basic-flow-response 24.5.txt')
		* print response			
		Then status 200
