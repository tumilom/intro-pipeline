@ignore
@cc_paymentPreferences-basic-flow
Feature: ccapi payment-preferences
    ...
    Scenario: <customerNo> payment-preferences
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/api-cc/payment-preference/payment-preference-basic-flow-response 24.2.txt')
		* print response
