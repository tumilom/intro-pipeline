...
Feature: Read Case Overview
    ...
    Scenario: <medFeesNo> Case Overview
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadCaseOverview-MedFeesNo/readCaseOverview-MFN-ACC45 response-24.7.txt')			
		Then status 200
