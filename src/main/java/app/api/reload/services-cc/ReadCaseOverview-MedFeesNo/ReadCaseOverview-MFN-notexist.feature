@ignore
@ReadCaseOverview-MFN-notexist
Feature: Read Case Overview - Med Fees No claim does not exist in Eos
    Background: 
	...
	Scenario: <medFeesNo> Case Overview
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-cc/ReadCaseOverview-MedFeesNo/ReadCaseOverview-MFN-notexist-response-24.2.txt')
		Then status 200
