...
Feature: Read Case Overview
    ...
    Scenario: <medFeesNo> Case Overview
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadCaseOverview-CaseId/ReadCaseOverview-Case-Id-response-24.7.txt')	
