...
Feature: ReadCustomerDetails
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadCustomerDetails/ReadCustomerDetails-response-24.7.txt')
		* print response
		Then status 200
