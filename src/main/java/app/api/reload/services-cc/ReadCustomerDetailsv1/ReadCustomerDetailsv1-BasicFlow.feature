#@ignore
@ReadCustomerDetailsv1-BasicFlow
Feature: ReadCustomerDetails
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadCustomerDetailsv1/ReadCustomerDetailsv1-response-24.7.txt')
		* print response
		Then status 200
