...
Feature: ReadClaimStatus
    Background: 
		...
		* def STR_DATEOFBIRTH = '2010-05-25'
    ...
    Scenario: ReadClaimStatus
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-cc/ReadClaimStatus/ReadClaimStatus-invalid-bday-response-24.2.txt')
		* print response
		Then status 200
