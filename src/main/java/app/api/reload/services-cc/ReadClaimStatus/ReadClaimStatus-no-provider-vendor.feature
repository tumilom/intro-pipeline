@ignore
@ReadClaimStatus-no-provider-vendor
Feature: ReadClaimStatus
    ...
    Scenario: ReadClaimStatus
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-cc/ReadClaimStatus/ReadClaimStatus-no-provider-vendor response-24.2.txt')
		* print response
		Then status 200
