...
Feature: Read Case Overview
    ...
    Scenario: <medFeesNo> Case Overview
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadCaseOverview-PO-No/ReadCaseOverview-PO response-24.7.txt')			
		Then status 200
