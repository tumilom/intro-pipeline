#@ignore
@readCaseOverview-Case-Ref-ACC45
Feature: Read Case Overview
    ...
    Scenario: <medFeesNo> Case Overview
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadCaseOverview-CaseRef/ReadCaseOverview-Case-Ref-response ACC45 24.7.txt')			
		Then status 200
