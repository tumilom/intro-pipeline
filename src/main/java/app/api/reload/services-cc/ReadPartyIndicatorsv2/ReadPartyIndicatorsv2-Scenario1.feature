#@ignore
@ReadPartyIndicatorsv2-Scenario1
Feature: Read Party Indicator
    ...
    Scenario: all expected fields returned when Communication Plan Indicator status is Active
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadPartyIndicatorsv2/ReadPartyIndicatorsv2-Scenario1-response-24.8.txt')
		* print response
		Then status 200
