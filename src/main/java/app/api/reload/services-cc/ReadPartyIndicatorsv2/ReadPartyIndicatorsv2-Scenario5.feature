#@ignore
@ReadPartyIndicatorsv2-Scenario5
Feature: Read Party Indicator
    Background: 
		...
		* def strCustomerNumber = '20106369a'
		# def strIndicatorOids = '20134028'
		* def strUserid = 'OASIS'
		* def strCorrId = 'ANY'
		
    Scenario: Invalid customer no input
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadPartyIndicatorsv2/ReadPartyIndicatorsv2-Scenario5-response-24.8.txt')
		* print response
		Then status 200
