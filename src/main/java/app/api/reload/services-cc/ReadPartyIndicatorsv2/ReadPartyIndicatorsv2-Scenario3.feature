#@ignore
@ReadPartyIndicatorsv2-Scenario3
Feature: Read Party Indicator
    ...
    Scenario: All expected fields are returned when Communication Plan Indicator status is Inactive
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadPartyIndicatorsv2/ReadPartyIndicatorsv2-Scenario3-response-24.8.txt')
		* print response
		Then status 200
