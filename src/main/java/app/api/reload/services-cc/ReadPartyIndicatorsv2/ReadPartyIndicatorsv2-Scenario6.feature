#@ignore
@ReadPartyIndicatorsv2-Scenario6
Feature: Read Party Indicator
    ...
    Scenario: Invalid customer no input
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-cc/ReadPartyIndicatorsv2/ReadPartyIndicatorsv2-Scenario6-response-24.8.txt')
		* print response
		Then status 200
