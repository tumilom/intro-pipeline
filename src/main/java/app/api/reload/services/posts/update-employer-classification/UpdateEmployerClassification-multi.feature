@ignore
@UpdateEmployerClassification-multi
Feature:
    Background: 
    ...
    Given url WSC_JUNO_URL + 'UpdateEmployerClassification'
        ...
        * print 'Updating employer <employerId> classification units'
        And request read('classpath:app/api/reload/services/posts/update-employer-classification/UpdateClassificationUnit-multi-request.xml')
        When method post
		* print response
        Then status 200
