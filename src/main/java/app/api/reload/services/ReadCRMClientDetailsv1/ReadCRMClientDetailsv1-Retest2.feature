...
Feature: ReadCRMClientDetailsv1
    ...
    Scenario: ReadCRMClientDetailsv1
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services/ReadCRMClientDetailsv1/ReadCRMClientDetailsv1-Retest2-response-24.5.txt')
		* print response
		Then status 200
