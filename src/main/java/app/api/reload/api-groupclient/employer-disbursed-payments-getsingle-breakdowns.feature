@ignore
@gc_employer-disbursed-payments-getsingle-breakdowns
Feature: gcapi employer-disbursed-payments-getsingle-breakdowns
    ...
    Scenario:
		* def path = '/claims/disbursed-payments/<path-peiId>/breakdowns'				
		...
		* print response
		...
		#* karate.write(responseStr, '../src/test/java/app/api/reload/api-groupclient/disbursed-payments/employer-disbursed-payments-getsingle-breakdowns-response 24.5.txt')
