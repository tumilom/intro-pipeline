...
Feature: Read Invoice
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadInvoice/ReadInvoice-invalid-referenceno.txt')
		* print response
		Then status 200
