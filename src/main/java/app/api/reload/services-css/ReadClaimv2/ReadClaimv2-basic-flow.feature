...
Feature: Read Claim
    ...
    Scenario: Case Owner
        Given url WSC_CSS_URL +'ReadClaimv2'
		...
		* karate.write(responseStr, '../src/main/java/app/api/reload/services-css/ReadClaimv2/ReadClaimv2-basic-flow-response 24.7.txt')
		* print response
		Then status 200
