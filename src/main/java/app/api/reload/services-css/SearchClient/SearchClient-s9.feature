...
Feature: Search Client used by MYACC self trigger invite
    ...
    Scenario: No DOB provided in the query
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s9-response 24.5.txt')
		Then status 200				
