...
Feature: Search Client used by MYACC self trigger invite
    ...
    Scenario: No mobile number but email added
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s2-response 24.5.txt')
		Then status 200				
