...
Feature: Search Client used by MYACC self trigger invite
    Background: 
		...
		* def str_NHINo = 'AAA12345'
		* def str_emailAddress = ''
		* def str_areaCode = '04'
		* def str_teleponeNo = '21020987654'
		
    Scenario: Invalid NHI format like AAA12345 (more than 7 characters length)
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s13.b-response 24.5.txt')
		Then status 200				
