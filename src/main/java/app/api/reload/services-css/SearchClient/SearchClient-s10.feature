...
Feature: Search Client used by MYACC self trigger invite
    ...
    Scenario: Neither email nor mobile number provided in the query
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s10-response 24.5.txt')
		Then status 200				
