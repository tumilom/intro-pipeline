...
Feature: Search Client used by MYACC self trigger invite
    Background: 
		...
		* def str_teleponeNo = '012345678900000000000'
		
    Scenario: Invalid telephone number (more than 20 characters length)
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s15-response 24.5.txt')
		Then status 200				
