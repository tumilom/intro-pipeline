...
Feature: Search Client used by MYACC self trigger invite
    Background: 
		...
		* def str_DateOfBirth = '2000/12/3'
		* def str_NHINo = 'AAA1234'
		* def str_emailAddress = ''
		* def str_areaCode = '04'
		* def str_teleponeNo = '21020987654'
		
    Scenario: Invalid DOB format provided in the query
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s11-response 24.5.txt')
		Then status 200				
