...
Feature: Search Client used by MYACC self trigger invite
    Background: 
		...
		* def str_emailAddress = 'O\'Brein-289/2@gmail.com'
		* def str_areaCode = '04'
		* def str_teleponeNo = '020123457891'
		
    Scenario: Email has an apostrophe
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s7-response 24.5.txt')
		Then status 200				
