...
Feature: Search Client used by MYACC self trigger invite
    Background: 
		...
		* def str_areaCode = '12345678900'
		* def str_teleponeNo = '21020987654'
		
    Scenario: Invalid area code (more than 10 characters length)
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s14-response 24.5.txt')
		Then status 200				
