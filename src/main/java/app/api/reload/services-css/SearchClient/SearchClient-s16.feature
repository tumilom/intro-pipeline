...
Feature: Search Client used by MYACC self trigger invite
    ...
    Scenario: Mismatched first name provided
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s16-response 24.5.txt')
		Then status 200				
