...
Feature: Search Client used by MYACC self trigger invite
    ...
    Scenario: Party is 15 years old
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s18-response 24.5.txt')
		Then status 200				
