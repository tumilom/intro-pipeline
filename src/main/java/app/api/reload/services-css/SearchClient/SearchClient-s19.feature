...
Feature: Search Client used by MYACC self trigger invite
    ...
    Scenario: Client has no claim since 09/07/2007 (TOCCASE.DATECREATED)
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/SearchClient/SearchClient-s19-response 24.5.txt')
		Then status 200				
