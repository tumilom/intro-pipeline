@ignore
@update-managed-indicators-opt-out
Feature:
    ...
    Background:
        ...
        * def payload = read('classpath:app/api/reload/services-css/posts/updateManagedIndicators/update-managed-indicators-opt-out.xml') 
        And request payload
        When method post
        * print response
        Then status 200
