...
Feature:
    ...
    Scenario: Create claimant address for <eosCustomerNo>
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/posts/update-claimant/update-claimant-invalid response 24.2.txt')
        * print response
        Then status 200