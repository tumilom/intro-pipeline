@ignore
@CreateOutcomeMeasure-add-Psychosocial-Tool
Feature:
    Background:
        ...
        * def payload = read('classpath:app/api/reload/services-css/posts/createOutcomeMeasure/CreateOutcomeMeasure-add-Psychosocial Tool.xml') 
        And request payload
        When method post
        * print response
        Then status 200
