...
Feature: Read ReadOutcomeMeasures
    ...
    Scenario: ReadOutcomeMeasures
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadOutcomeMeasures/ReadOutcomeMeasures-WHODAS-response 24.2.txt')
		* print response
		Then status 200
