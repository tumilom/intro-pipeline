@ignore
@ReadCaseManagementDetails-basic-flow
Feature: Read Case Management Details
    Background: 
		...
		* def str_casenumber = '10060066478'
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadCaseManagementDetails/ReadCaseManagementDetails-basic-flow-response 24.2.txt')
		* print response
		Then status 200
