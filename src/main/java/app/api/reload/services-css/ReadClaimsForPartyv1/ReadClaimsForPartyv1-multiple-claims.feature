@ignore
@ReadClaimsForPartyv1-multiple-claims
Feature: Read Case Owner
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadClaimsForPartyv1/ReadClaimsForPartyv1-multiple-claims-response.txt')
		* print response
		Then status 200
