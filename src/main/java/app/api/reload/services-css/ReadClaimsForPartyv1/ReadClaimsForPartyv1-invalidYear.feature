@ignore
@ReadClaimsForPartyv1-invalidYear
Feature: Read Case Owner
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadClaimsForPartyv1/ReadClaimsForPartyv1-invalidYear-response.txt')
		* print response
		Then status 200
