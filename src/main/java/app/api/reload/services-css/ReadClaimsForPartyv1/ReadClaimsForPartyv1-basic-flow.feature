@ignore
@ReadClaimsForPartyv1-basic-flow
Feature: Read Case Owner
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadClaimsForPartyv1/ReadClaimsForPartyv1-basic-flow-response.txt')
		* print response
		Then status 200
