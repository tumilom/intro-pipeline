@ignore
@css_ReadTasks-multiple-cancelled-tasks
Feature: Read task
    Background: 
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadTasks/ReadTasks-multiple-cancelled-tasks-response 24.2.txt')
		* print response
		Then status 200
