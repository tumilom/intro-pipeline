...
Feature: Read Claim
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadClaim/ReadClaim-multiple-subcase-response 24.2.txt')
		* print response
		Then status 200
