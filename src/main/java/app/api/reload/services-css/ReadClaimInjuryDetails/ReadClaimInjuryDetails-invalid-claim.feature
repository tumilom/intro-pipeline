...
Feature: Read Claim
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadClaimInjuryDetails/ReadClaimInjuryDetails-invalid-claim-response 24.2.txt')
		* print response
		Then status 200
