@ignore
@ReadClaimInjuryDetails-multiple
Feature: Read Claim
    Background: 
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadClaimInjuryDetails/ReadClaimInjuryDetails-multiple-response 24.2.txt')
		* print response
		Then status 200
