@ignore
@ReadNextPaymentOutEvent-basic-flow
Feature: Read Claim
    Background: 
    ...
    Scenario: Case Owner
		...
		* karate.write(responseStr, '../src/test/java/app/api/reload/services-css/ReadNextPaymentOutEvent/ReadNextPaymentOutEvent-basic-flow-response 24.2.txt')
		* print response
		Then status 200
