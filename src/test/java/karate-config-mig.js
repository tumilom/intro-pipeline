function fn() {
    var docuserid = '?userid=SVC_APIM_EOS_DS_E17'
    var eosUrl = 'https://mig-api.acc.fineos.com'
	var webappUrl = 'https://mig-webapp.acc.fineos.com'
    ...
    var config = { 
        ...
        ORDINARY_USER:{'userid':'oasis@fineos.com','userpass':'fineosKHK!34IGL3'},
        PAYMENTOFFICER_USER:{'userid':'divinaol@fineos.com','userpass':'fineosKHK!34IGL3'}
    };
	...
	karate.set ("JSONAPI_HTTP_HEADERS_CC", { 'Authorization': 'Bearer ' + authResult.response.access_token, 'Content-Type': 'application/json', 'userid': 'SVC_APIM_EOS_PS_E17'})
	karate.set ("DOCUMENT_JSONAPI_HTTP_HEADERS", { 'Authorization': 'Bearer ' + authResult.response.access_token, 'Content-Type': 'application/json', 'userid': 'SVC_APIM_EOS_DS_E17'})
	karate.set ("DOCUMENT_WSC_HTTP_HEADERS", { 'Authorization': 'Bearer ' + authResult.response.access_token, 'Content-Type': 'application/xml', 'userid': 'SVC_APIM_EOS_DS_E17'})
